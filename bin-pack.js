/*
  This code comes from:
    https://github.com/armollica/bin-pack/

  At the time of this writing it has not been touched in 9 years, and
  there is no LICENSE file or copyright notice included, so I assume
  it was intended to be open-source.
*/
